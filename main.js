...
function createAccountsTable() { 
    ...
    <tr>
        ...
        <td>${account.email}</td>
        <td>${account.phone}</td>
        <td><button data-id="${i}" class="edit-btn btn btn-sm btn-success edit">Edit</button></td>
        <td><button data-id="${i}" class="delete-btn btn btn-sm btn-danger delete">Delete</button></td>
    </tr>
        `
    }
